...
public struct VisualDocs_State_PreviewProvider: PreviewProvider {
    public static var previews: some View {
        TabView {
            ...
            VisualDocs_State_III(products: [ProductY(title: "1", isFavorited: false), ProductY(title: "2", isFavorited: true)]).tabItem({ Text("3") })
